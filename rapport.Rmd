...
Andel av motakker av offentlig hjelp 


```{r fig02, echo=FALSE, warning=FALSE, message=FALSE, include=FALSE}    

## Dataset med senter mer enn 20 (>20)
offPro <- DataT02[, .N, by = .(yr2, get(v04))]
bNA(offPro, 99)

offPro <- offPro[yr2 != 99]
setkey(offPro, yr2)
offPro[, sum := sum(N), by = yr2]
offPro[, pros := N / sum * 100, by = .(yr2, get)]
