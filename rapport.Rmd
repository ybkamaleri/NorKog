...
Poliklinikker med deltaker mindre enn 20 er eksludert i analysen, dette utgjør at
total pasienter som er inkludert i analysen her blir **`r dataN`** personer. I tillegg er
missing data i relevante analysene eksludert. De er som følgende:
