...
Det er `r inkn` sentre inkludert i analysen. [Her kan det ligge mer tekst om det er ønkelig]

```{r fig01, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}

innText <- fig01Data[, pos := ifelse(N < 200, 0, 1)]
...
Data[, yr := as.integer(format(as.IDate(DATO_US, format = "%m/%d/%Y"), "%Y"))]
